...
\toprule
\textbf{Scenario} & \textbf{\#} & \textbf{Source} \\
\midrule
Generic Rental Agreement \newline \textit{rent, duration, deposit, maintenance} & 4 & Franceschetti \\
\addlinespace
Generic Loan Agreement \newline \textit{rate, term, collateral} & 3 & Franceschetti \\
\addlinespace
Generic Merger \newline \textit{valuation, retention, governance} & 3 & Franceschetti \\
\addlinespace
Joint Venture \newline \textit{R\&D budget, revenue split, data sharing, authority} & 4 & New \\
\addlinespace
Employment Contract \newline \textit{salary, remote work, training, equity, scope} & 5 & New \\
\bottomrule
\end{tabular}
\end{table}
