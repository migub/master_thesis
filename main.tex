...
This distribution is not deliberately chosen but emerges naturally from the composition of the issue pool: since most scenarios contain both distributive and compatible issues, the majority of random two-issue pairings produce mixture games. Purely compatible pairings are rare because few issues share fully aligned payoff structures.
