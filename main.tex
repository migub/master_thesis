...
This distribution reflects the structure of real-world negotiations, which negotiation theory has long characterized as fundamentally mixed-motive: \citet{walton1965behavioral} introduced the concept of mixed-motive bargaining, arguing that virtually all labor and business negotiations combine elements of both distributive (value-claiming) and integrative (value-creating) dynamics. \citet{lax1992manager_summary} reinforced this view with the ``negotiator's dilemma,'' where most practical negotiations require balancing competitive and cooperative tactics. The issues in each scenario were designed to mirror such realistic settings (e.g., salary vs.\ remote work in an employment contract, or revenue split vs.\ data sharing in a joint venture), and pairing them naturally produces a mixture-heavy distribution consistent with these theoretical expectations.
