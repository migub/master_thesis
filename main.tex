...
\begin{figure}[H]
    ...
    \caption{GRPO deal quality during training, computed only over successful negotiations. Left: agreed $U_A$ (excluding failed negotiations). Right: agreed Nash ratio.}
...
\begin{figure}[H]
    ...
    \caption{LA-GRPO negotiation performance during training across three $\lambda$ configurations (up to 2000 steps). Same smoothing and layout as Figure~\ref{fig:training_performance}.}
...
\begin{figure}[H]
    ...
    \caption{LA-GRPO deal quality during training, computed only over successful negotiations. Left: agreed $U_A$. Right: agreed Nash ratio.}
...
\begin{table}[H]
\centering
\caption{LA-GRPO agreed-only Nash ratio by archetype. Bold indicates best per row. The LA-GRPO evaluation uses a reduced game suite covering three core archetypes (200 games total per model).}
...
\begin{figure}[H]
    ...
    \caption{$U_A$ vs.\ $U_B$ for all GRPO models (agreed negotiations only). Diamond marks the mean outcome. Red crosses at origin indicate failed negotiations.}
...
\begin{figure}[H]
    ...
    \caption{$U_A$ vs.\ $U_B$ for all LA-GRPO models (agreed negotiations only).}
