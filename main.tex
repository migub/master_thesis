...
This distribution reflects the structure of real-world negotiations, where most interactions involve a mix of contested and aligned interests rather than being purely competitive or purely cooperative. The issues in each scenario were designed to mirror realistic negotiation settings (e.g., salary vs.\ remote work in an employment contract, or revenue split vs.\ data sharing in a joint venture), and pairing such issues naturally produces a mixture-heavy distribution.
