...
The archetype distribution is not a deliberate design target but an emergent consequence of the issue pool composition. Each scenario contains issues designed to be realistic---for example, salary and equity are naturally distributive (one party's gain is the other's loss), while training budget and data sharing tend to be compatible (both parties benefit from higher values). Since most scenarios contain more distributive than compatible issues, randomly pairing them into two-issue games produces a majority of mixture configurations. This outcome is consistent with negotiation theory: \citet{walton1965behavioral} characterized real-world negotiations as fundamentally mixed-motive, combining both value-claiming and value-creating dynamics, and \citet{lax1992manager_summary} reinforced this with the ``negotiator's dilemma.''
