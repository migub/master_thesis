...
Only a low-rank subset of parameters---the \textbf{LoRA adapters}---is trainable \citep{hu2021loralowrankadaptationlarge}. This modular fine-tuning strategy allows efficient weight updates on limited hardware while preserving the base model's general linguistic competence. The specific model and LoRA configuration are:
...
\end{document}% Last edited: 2026-04-07T17:18:58Z
