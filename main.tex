...
\textcolor{gray}{[PLACEHOLDER: Pareto frontier plots --- $U_A$ vs.\ $U_B$ scatter for different $\lambda$ configurations, ideally per archetype.]}

\textcolor{gray}{[PLACEHOLDER: Nash product comparison across game types. Bar chart or table showing how fair-only approaches the Nash bargaining solution while self-only shifts toward the $U_A$ maximum.]}
