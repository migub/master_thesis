...
A negotiation is classified as \textit{agreed} if either agent receives a positive payoff ($U_A > 0$ or $U_B > 0$). This includes partial agreements where agents agree on some but not all issues---a known limitation, as partial agreements can produce positive rewards for incomplete deals, slightly inflating agreement rates.
