...
LA-GRPO training runs with all three cooperative reward configurations (self-only, fair-only, all-equal) were conducted and are evaluated in Section~\ref{sec:results}.
...
A detailed per-archetype breakdown of evaluation metrics is presented in Sections~5.2 and~5.3.
