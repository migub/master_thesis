...
\begin{tabular}{lccc}
\toprule
\textbf{Model} & \textbf{Valid} & \textbf{Nash} & \textbf{Utilitarian} \\
\midrule
Base Model & 0.992 & 0.639 & 0.917 \\
GRPO self-only & \textbf{0.993} & 0.639 & 0.916 \\
GRPO fair-only & \textbf{0.993} & 0.631 & \textbf{0.935} \\
