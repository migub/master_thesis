...
\paragraph{Extended Game Set.} We extend Franceschetti's game set from 3 scenarios, 10 issues, and 23 game combinations to \textbf{5 scenarios, 19 issues, and 48 game combinations}:
...
\begin{enumerate}
    ...
    \item \textbf{Extended LAMEN environment} with 5 scenarios, 19 issues, and 48 game combinations (vs.\ Franceschetti's 3/10/23), including new Joint Venture and Employment Contract scenarios with integrative issue structures.
\end{enumerate}
